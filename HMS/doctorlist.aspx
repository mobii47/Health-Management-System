<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doctorlist.aspx.cs" Inherits="sheikh.doctorlist" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="doctor" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="cnic"
                ShowHeaderWhenEmpty="true"

                OnRowCommand="doctor_RowCommand" OnRowEditing="doctor_RowEditing" OnRowCancelingEdit="doctor_RowCancelingEdit"
                OnRowUpdating="doctor_RowUpdating" OnRowDeleting="doctor_RowDeleting"

                BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="329px" Width="1233px" OnSelectedIndexChanged="doctor_SelectedIndexChanged">
                <%-- Theme Properties --%>
